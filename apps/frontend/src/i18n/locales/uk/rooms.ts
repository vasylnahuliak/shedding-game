const rooms = {
  screen: {
    ...
    subtitle: 'Приєднайтеся до наявної кімнати\nабо створіть власну гру',
  ...
  createRoom: {
    ...
    gamePaceHint: 'Натисніть на емоджі, щоб обрати темп і побачити максимум часу на хід.',
  ...
  statistics: {
    ...
    emptyDescription: 'Зіграйте партію, щоб тут зʼявилися історія, перемоги та вінрейт.',
    noData: 'Немає даних',
  },
  notices: {
    roomInactiveBase:
      'Кімната більше неактивна (гра вже почалася або кімнату закрито), тому вас повернуто до списку кімнат.',
    detailPrefix: 'Деталі',
  },
  debugModes: {
    none: 'None',
    configTitle: 'Режим налагодження',
