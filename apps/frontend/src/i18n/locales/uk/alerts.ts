const alerts = {
  ...
  messages: {
    ...
    roomNoLongerActiveShort:
      'Кімната більше неактивна (гра вже почалася або кімнату закрито). Оберіть іншу кімнату.',
    ...
    kickedByHost: 'Хост видалив вас із кімнати',
    kickedByTurnTimeout: 'Вас видалено з гри через неактивність під час ходу',
